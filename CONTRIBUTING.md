...
Interested in helping build xpersist? Have code from your work that
...
regarding development in xpersist for maintainers and contributors.
...
- Any details about your local setup that might be helpful in troubleshooting,
  specifically the Python interpreter version, installed libraries, and xpersist
  version.
...
xpersist could always use more documentation. What exactly is needed?
...
3. Install dependencies into a new conda environment::
   ...
   $ conda activate xpersist-dev
   ```

4. Make an editable install of xpersist by running::

   ```bash
   $ python -m pip install -e .
   ```

5. Install `pre-commit <https://pre-commit.com>`\_ hooks on the xpersist repo::
   ...
   Now you have an environment called `xpersist-dev` that you can work in.
